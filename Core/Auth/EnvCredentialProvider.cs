/*
 * Copyright 2023 Ct Technologies Co.,Ltd.
 * 
...
namespace CtCloud.SDK.Core.Auth
{
    public class EnvCredentialProvider : ICredentialProvider
    {
        private const string AkEnvName = "CTCLOUD_SDK_AK";
        private const string SkEnvName = "CTCLOUD_SDK_SK";
        private const string ProjectIdEnvName = "CTCLOUD_SDK_PROJECT_ID";
        private const string DomainIdEnvName = "CTCLOUD_SDK_DOMAIN_ID";
        private const string SecurityTokenEnvName = "CTCLOUD_SDK_SECURITY_TOKEN";
